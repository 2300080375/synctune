...
export default function Player({ currentSong, isPlaying, isLoading, onPlay, sound }) {
      ...
      <div style={{display:'flex', alignItems:'center', gap:'16px'}}>
        ...
        <div style={{display:'flex', alignItems:'center', gap:'8px', flexShrink:0}}>
          ...
          <button
            ...
            style={{
              width:'42px', height:'42px', borderRadius:'50%', border:'none', cursor: (isLoading || !currentSong) ? 'not-allowed' : 'pointer',
